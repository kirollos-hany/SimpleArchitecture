        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceInfo_DeviceType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeviceInfo_Browser = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DeviceInfo_Os = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TimeStamp = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ActionBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ActionByRoles = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AffectedColumns = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActionsAudits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActionsAudits_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAgent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Device_DeviceType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Device_Browser = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Device_Os = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RefreshToken_Token = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RefreshToken_RevokedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
